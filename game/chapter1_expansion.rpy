...
label ch1_exp_kitchen_night:
    ...
    elena "抱歉，我没想到您还没休息。我在……我在热牛奶。厨房的老人们提过，老夫人以前睡不着的时候，总爱喝一杯热牛奶。"

    "你注意到她说的「老夫人」——那是指你早逝的母亲。可艾琳娜进城堡时，母亲已经走了许多年。这些事，想必是城堡里的老人讲给她听的。"
    ...
    $ hide_all_chars("elena_img")
    show elena_img at left with dissolve
    elena "嗯。来了城堡之后，常听她们念叨老夫人。说她心善，收留过好些没人要的孩子，教她们识字、做针线，是个很温柔的人。"
...
label ch1_exp_ramparts_night:
    ...
    captain "我跟随老领主十二年了。从他把我收留下来那天起。他教我带兵，也教我怎么做一个好的卫队长。"
...
label ch1_exp_elena_encounter:
    ...
    "这是你在艾登堡的第一个夜晚。这座城堡藏着的东西，比你预想的多得多。"

    "你闭上眼睛。在黑暗中，你仿佛看到了父亲坐在书桌前的背影——挺拔的，孤独的。"
...
label ch1_exp_morning_council:
    ...
    menu:
        ...
        "改革税制「重新分配」":
            ...
            player "我父亲留下了一个好领地，也留下了一些旧账。从今天起，一笔一笔清。"
...
label ch1_exp_training_yard:
    ...
    if prologue_study_focus == "commerce" and ch1_exp_sparring_result == "defeat":
        "离开校场的时候，你路过军械库。门敞开着，里面的情形一目了然——生锈的铁剑、开裂的盾牌、缝了又缝的皮甲。"
        "你驻足片刻，心中已经有了盘算。"
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        ...
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        player "（自言自语）如果我是指挥官，对付这种打法……应该先用轻步兵消耗他的第一波进攻，然后侧翼包抄。"
        hide player_char_img with dissolve
        "你把这个想法记了下来。"
        $ change_stat("intrigue", 3)
        $ change_stat("reputation", 3)
...
label ch1_exp_village_visit:
    ...
    "村庄不大——茅草屋顶的泥房、鹅卵石铺成的主街、一口石井、一座小教堂、一家铁匠铺和一个露天市场。"

    "空气中混杂着各种气味——面包房传来的酵母香、牛棚的腥膻、晾晒的腌肉发出的咸味，以及泥泞中不可言说的其他味道。"

    "村民们看到你时，有些迟疑。有人认出了你——消息传得很快。不一会儿，街道两侧就聚集了一些人，远远地观望着。"
    ...
    "面包房里，师傅的妻子硬塞给你一块刚出炉的黑麦面包。粗糙但扎实，带着麦秆的清香。"

    "路过教堂时，老牧师拦住你说了几句。屋顶漏了，他向主教申请修缮经费两年了，没有回音。"
...
label ch1_exp_evening_feast:
    ...
    menu:
        ...
        "气势磅礴「宣示主权」":
            ...
            player "我虽然年轻。但我手里有剑，身后有城墙，城墙里有跟我一条心的人。试图试探艾登堡底线的——我建议三思。"

            "你停顿了一秒，然后语气忽然柔和了。"

            player "但对朋友，我永远敞开大门。今晚在座的都是朋友。为了我们的友谊。干杯。"

            "掌声。但这次的掌声里夹杂着一丝敬畏。贝尔福骑士大声叫好。温德尔骑士面无表情。威尔斯子爵的眼睛闪了一下——像是看到了一把出鞘的剑。"
    ...
    "这一天你做了太多事——夜探城堡、主持议事、校场比武、巡视村庄、应对宴会。每一件事都像是一场考试。"
    ...
    "你只是一个站在窗前的二十二岁的年轻人，看着脚下沉睡的领地和头顶冷寂的星空。"
    ...
    storyteller "没有人知道他将成为怎样的领主——包括他自己。"

    storyteller "但有一件事是确定的——"

    storyteller "冬天快来了。"

    storyteller "而他的故事才刚刚开始。"
