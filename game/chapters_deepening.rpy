...
label ch3_deep_captain_scar:
    ...
    "但你注意到，比起正在包扎的新伤，他更在意左肩那道从锁骨延伸到肩胛的旧疤。"
...
label ch4_deep_dungeon_echo:
    ...
    "你用手指轻轻触摸那些刻痕。冷硬的石头，刻痕深而锐利，说明他下了很大的力气。"
...
label ch5_deep_prayer:
    ...
    "整座城堡的寂静里透着张力，那种暴风雨前的紧绷感压得人喘不过气。"

    "黄昏时分，教堂敲响了不同于平日的钟声——沉而缓，是召集所有人的信号。"
