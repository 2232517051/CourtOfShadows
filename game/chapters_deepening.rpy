...
label ch2_deep_spy_refuse:
    ...
    "在这个尔虞我诈的世界里，信任是最昂贵的货币——我不打算轻易花出去。"
...
label ch2_deep_baron_letter:
    ...
    "艾琳娜的表情比平时更加严肃。她从袖中取出一封折叠的信纸递给我。"
...
label ch2_deep_church_midnight:
    ...
    "又是一个辗转难眠的夜晚。"
    "自从接手艾登堡以来，我的睡眠就像是被切成了碎片——"
    "每一段都太短，每一段都充满了噩梦。"

    "我披上外衣，走出卧室。走廊里的长明灯只剩下两盏还亮着，石板地凉得渗人。"
...
label ch4_deep_queen_weakness:
    ...
    "好奇心驱使我跟了上去。走廊里暗淡的火把勉强照亮脚下的路——"
    "我贴着墙壁，控制着呼吸，跟在她身后约三十步的距离。"

    "王后走进那间房间，没有锁门——也许是因为她确信不会有人跟来。"

    "我在门缝外驻足。"

    "透过门缝，我看到了一幅令人意想不到的画面——"
...
label ch4_deep_dungeon_echo:
    ...
    "我来这里本是为了查看关押政治犯的情况——作为朝臣的权利之一。"
    "但在一间空牢房的墙壁上，我发现了一些字迹。"
    ...
    "'{i}第一百八十天。王后的使者来了。她提出条件：交出北方联盟的名单，就释放我。{/i}'"
    ...
    "父亲从未和我提起过这些。也许他觉得我还太小。也许他想保护我不受家族沉重历史的压迫。"

    "但现在我知道了——我和王室的恩怨，不是从父亲的死开始的。"
    "它已经延续了至少三代人。"
...
label ch5_deep_letter_aldric_path:
    ...
    "我提起笔。"
    "写给奥尔德里克——那个从小看着我长大的老管家。"
    "如果我不在了，他要承担起保护这些人的责任。"
