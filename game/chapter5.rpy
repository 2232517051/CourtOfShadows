...
label ch5_counsel_all:
    ...
    ## 未写——都不进此场景。与 dark_lily_joined 互斥(那批人这一夜去见影主)。
        ...
        "你没有停步。一个叔叔和一个囚徒都有理由说这句话。你不打算分清是哪一个。"
...
label ending_truth:
    ...
    ## 艾德蒙回响H: 清算大潮里叔叔/铁刺网的位置。命名铁律: captured/replaced
    ## 可用"艾德蒙", arrested/negotiated 只能"叔叔/首领"。真凶依旧不落定。
    if ch3_cult_leader_fate == "captured":
