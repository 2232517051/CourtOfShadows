...
label ch1_deep_father_grave:
    ...
    "奥尔德里克跟在你身后十步远的地方，不言不语。你没有回头，但能听到他那双旧皮靴踩过落叶的声音——沙沙，沙沙。"

    "你知道他不会走近，除非你主动开口。这是他侍奉了两代人后学会的分寸感。"

    "小路穿过一片白桦林。树干在雾气中泛着银白色的光。风吹过树梢，带来远处河水的潮湿气息。"
    ...
    menu:
        "将剑放在墓碑前「这是我的誓言——我会用力量守护这片土地」":
            ...
            $ hide_all_chars()
            "你把短剑从墓碑前拾起，插回剑鞘。剑柄冰凉，露水从指缝间滑下来。"
        ...
        "采一束野花，放在墓碑前默默祈祷「愿神灵庇佑您的灵魂」":
            ...
            "风吹过来，花瓣晃了晃。你知道这只是风。但这一刻，你愿意当作他听见了。"
...
label ch1_deep_patrol:
    ...
    "清晨的阳光从树冠间漏下来，在路面上洒下斑驳的光影。空气里弥漫着松脂和湿土的气味。远处传来啄木鸟笃笃笃的敲击声。"
    ...
    "你们继续向北，经过了两个小村子。村民们看到领主巡逻队经过，纷纷停下手中的活计，有人行礼，有人只是目送。"
    ...
    menu:
        ...
        "记下来，回去再统一安排「这不是唯一需要修的东西」":
            ...
            $ hide_all_chars()
            "你不能见一个修一个，资源很快就会耗光。话是这么说，可对岸那几个人还得再等下去。"
    ...
    menu:
        ...
        "先回去报告，加强巡逻「不要打草惊蛇」":
            ...
            "你点了点头。只有两个人，确实不该追进别人的地盘。代价是你失去了跟住对方、弄清他们来路的机会——这一回，你选了稳。"
    ...
    "你现在知道了——你拥有的东西比你以为的少，要操心的事比你以为的多。"
...
label ch1_deep_court:
    ...
    menu:
        "自掏腰包付面包钱+给少年安排工作" if wealth >= 50:
            ...
            player "另外，你的面包铺要不要再请一个学徒？ 每天给他一顿饭+月底两枚银币。少年我作担保——能扛能跑，算数学得会。"
    ...
    menu:
        ...
        "支持商人「过时的税法不应该选择性执行」":
            ...
            "一个官员记恨了你，一个商人欠了你人情。这笔账现在还算不清。"

    hide aldric_img with dissolve

    "三个案子审完。你的后背已经被汗水浸湿了——坐了一上午，比骑马巡逻还累。"
...
label ch1_deep_market:
    ...
    "窄窄的土路两边挤满了摊位。卖布的、卖铁锅的、卖草药的、卖腌鱼的。还有一个老妇人蹲在角落里卖自己编的柳条篮子。鱼腥味、香料味、烟熏味和人群的汗酸味搅在一起，呛得你皱了皱鼻子。"
    ...
    menu:
        "回去派兵取缔「黑市必须关闭。平民不需要武器。」":
            ...
            "她说的风险你不是没想到。蛇头砍了，蛇身还在，你也清楚。但你现在要的就是先把这摊东西从台面上掀掉。"
...
label ch1_deep_elena_lesson:
    ...
    menu:
        "第一句是谎话——六年太长了，你看起来不像干了那么久的人":
            ...
            elena "您注意到了年龄和经验对不上，说明您在动脑子。但您漏了更要紧的——身体。我说第一句的时候，整个人是松的，没有一点防备的反应。一般来说，这种状态下说的是真话。"
    ...
    "她把那三个小玻璃瓶推到你面前。每个瓶子里装着不同颜色的液体——一个透明、一个淡黄、一个微微泛紫。"
...
label ch1_deep_old_guard:
    ...
    "床头靠墙立着一把剑。制式很老，鞘上的漆磨没了，剑柄尾端有一个磨得快平的记号——你看不出那是什么纹样。"
    ...
    "「入伍那年，一个不肯留名的老头传给我的。他说这剑守过比城堡更要紧的东西。」"

    "「柄上那个记号，我问了四十三年，没人认得。大人要是不嫌弃——它还能再守一任领主。」"
    ...
    "老人转过头，直直地看着你。那双浑浊的蓝眼睛里，突然闪过一丝清明。"
...
label ch1_deep_cellar:
    ...
    $ hide_all_chars()
    "那天夜里，你又把父亲的笔记本翻了一遍。烛光下，那些密码文字你一个也认不出来。"

    "父亲留下的不只是一座城堡和一个头衔。"

    "那些密码和密道背后藏着什么，他至死也没来得及告诉你。"
...
label ch1_deep_sunset:
    ...
    "太阳正在落下。天边是大片浓烈的橘红，云缘那一线发亮，刺得人眯眼。远处的山脊已经看不清细节，只剩一道发黑的轮廓。"
    ...
    if power >= intrigue and power >= faith:
        ...
        "你不会变成暴君。但你要让人忌惮——让每一个想动艾登堡的人，在伸手之前先掂量一下后果。"

    elif intrigue >= power and intrigue >= faith:
        "你眯起了眼睛，目光扫过远处模糊的地平线。在那之后——是你看不到的东西。"
        "这几天你学到了最重要的一课：你看到的永远只是表面。"
        "你不需要比所有人都强。你需要在所有人开口之前——就知道他下一句会说什么。"

    elif faith >= power and faith >= intrigue:
        "你抬起头，看着天空中最后一抹金色的光。"
        "周围全是算计，你却还想留着点别的东西——可能是神，可能只是不愿把人都看成敌人。你不知道这份念头能撑到哪天，也许明天就被现实磨掉了。但今晚它还在。"

    else:
        "你还没有找到自己的道路。力量、智慧、信仰——它们都在你面前铺开。"
        "但也许不需要现在就选。"
