...
label ch4_exp_explore:
    ...
    "这座城市比你想象的更复杂——繁华与贫穷、秩序与混乱、忠诚与背叛，一切都交织在一起，像一团永远解不开的线。"
...
label ch4_exp_explore_cathedral:
    ...
    "穹顶高得令人眩晕，阳光透过彩窗洒下五彩斑斓的光斑，像上天洒落的碎片。"
    ...
    "在阳光下，它看起来庄严而圣洁。但你知道，在那些彩色玻璃窗的背后，隐藏着和王宫一样深的阴影。"
...
label ch4_exp_explore_slums:
    ...
    "街上的人——如果你能称他们为'人'的话——大多面黄肌瘦，衣衫褴褛。"
    ...
    menu:
        ...
        "离开这里，这不是你现在该关心的":
            ...
            elena "有些时候，在低处看到的东西，比在高处看到的更真实。"
...
label ch4_exp_court_social:
        ...
        "主动上前自我介绍":
            ...
            menu:
                "感谢他的称赞":
                    ...
                    "你收下名帖，感到手中的纸比普通纸重得多——也许这就是权力的重量。"
    ...
    menu:
        ...
        "不动声色地为父亲说话":
            ...
            narrator "她的语气软了一些。也许在她冷硬的外壳下，还残留着一丝对正直者的敬意。"
    ...
    "走廊上的灯火已经暗了一半。侍从们像幽灵一样无声地收拾着残局。"

    "你回头望了一眼灯火辉煌的宴会厅——那里的笑声还在继续，像一曲永不停歇的假面舞。"

    $ ch4_exp_court_impression = "complex"

    "在权力的旋涡中心，每个人都在演戏。"

    "而你——刚刚入场的新演员——还不知道自己被分配了什么角色。"
...
label ch4_exp_investigation:
    ...
    "窗外的王都沉入了黑暗之中，只有零星的灯火在远处闪烁——像是夜幕中被遗忘的星辰。"
    ...
    if ch4_exp_library_clue:
        ...
        "涂抹的痕迹很新，不超过三年。有人在系统性地销毁关于那段历史的记载。"
    ...
    "真相就像一幅拼图——你已经找到了许多碎片，但还缺少最关键的那几块。"
...
label ch4_exp_inv_lily_contact:
    ...
    narrator "「不是因为您的权力，而是因为您代表的东西——正统、正义、和一个更好的王国。」"
...
label ch4_exp_inv_solo:
    ...
    if not baron_is_darkflame_known:
        elena "间接力量包括：暗焰——暗百合的叛徒分支，由冯·哈根男爵指挥，但服从于王后。"
...
label ch4_exp_eve:
    ...
    "但你的大脑像一台停不下来的机器，不断地转动着，分析着每一种可能的情况。"
    ...
    captain "跟了您父亲十五年，跟您也快两年了。明天的觐见……说不紧张是假的。"
