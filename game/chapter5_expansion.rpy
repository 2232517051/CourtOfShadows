...
label ch5_exp_war_council:
    ...
    menu:
        ...
        "外交斡旋——以谈判化解战争" if alliance_church or faith >= 50:
            ...
            "外交是一场没有刀剑的战争。但它需要更强大的武器——耐心、智慧和不屈的意志。"
...
label ch5_exp_mobilize:
    ...
    menu:
        ...
        "全力囤积物资":
            ...
            "你知道——在围城战中，最后胜利的往往不是最强的一方，而是最能熬的一方。"
...
label ch5_exp_last_night:
    ...
    "教堂的钟声在午夜时分敲了十二下，每一声都沉重得像是在叩问灵魂。"
    ...
    if faith >= 30:
        ...
        menu:
            ...
            "站在一旁默默注视":
                ...
                "也许这就是信仰的力量——不是因为神真的会回应，而是因为人需要相信有什么在看顾。"
    ...
    "你深吸了一口气。寒冷的空气灌入肺中，像是一把冰刃剖开了所有的犹豫和恐惧。"
...
label ch5_exp_eve_of_battle:
    ...
    if faith >= 50:
        "你闭上眼，在心中默念了一句祷词。信仰不是武器——但它是让武器不被拔出的理由。"
    if loyalty >= 50:
