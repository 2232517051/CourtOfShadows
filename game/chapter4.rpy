...
label chapter4_start:
    ...
    "你最终还是躺下了。星空在树冠的缝隙中闪烁，像无数只沉默的眼睛。"
...
label ch4_palace:
    ...
    "你穿上了从艾登堡带来的最好的衣服——深蓝色的丝绒外套，银线绣着艾登堡的家徽——一只展翅的苍鹰。"
...
label ch4_elena:
    ...
    "觐见的事务告一段落，你感到前所未有的疲惫——不是身体上的，而是心理上的。"
...
label ch4_end:
    ...
    if elena_romance:
        "艾琳娜走到你身边，安静地站着。她的手轻轻碰了碰你的手指——像是一种无声的承诺。"
    else:
    ...
    centered "{size=+10}第四章 · 王都风云 · 完{/size}"
