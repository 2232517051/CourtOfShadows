...
label prologue_deep_childhood_2:
    ...
    menu:
        ...
        "走出来面对父亲。":
            ...
            "父亲看到你的时候，脸上的表情变了好几道——先是惊讶，然后是怒气，最后两样都褪了，只剩下疲惫。"
...
label prologue_deep_childhood_3:
    ...
    $ hide_all_chars("bertrand_img")
    show bertrand_img at left with dissolve
    bertrand "这把剑跟了我二十多年。当年你父亲还是个半大孩子，亲手刻给我的。"
...
label prologue_deep_youth_2:
    ...
    menu:
        "直接走过去，挡在男孩面前。":
            ...
            "你赢得了平民的尊重，但也得罪了伯爵的儿子。这可能不是明智之举。"
...
label prologue_deep_youth_3:
    ...
    menu:
        ...
        "感到被背叛，和他保持距离。":
            ...
            "你关上了心门。马库斯的背叛证实了你的一个怀疑：任何人都可能成为对手。"

            "从那晚起，你对马库斯说的每一句话，都是说给伯爵听的。"
        ...
        "利用这个局面——让马库斯传递假情报。":
            ...
            "你开始盘算能用这个渠道做些什么。但也意识到，这样做会让你和马库斯的信任永远回不来。"
    ...
    "你和马库斯之间，从此多了一道防备。以前他说什么你都信，现在你会先在心里掂量一下。"

    "这算长大吗？是亏了还是赚了？你现在还说不清。"
...
label prologue_deep_adult_1:
    ...
    "这座城市的表面是繁华、秩序和礼仪。表面底下做的是另一种生意。"

    "你十九岁。你慢慢摸出一条门道：在王都，消息比金子值钱。"
...
label prologue_deep_adult_2:
    ...
    menu:
        "拦住她，要求她表明身份。":
            ...
            "你站在窗前，心脏狂跳。那朵百合就绣在那个女人胸口。她闯进你的房间，活生生地站在你面前，警告你逃命——可你不知道她是来保护你，还是来盯着你的。"
    ...
    "不管你愿不愿意，已经有人把你算了进去——监视你的，警告你的，查你父亲的。因为你是金鹰之子。"
