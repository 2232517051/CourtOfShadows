...
label npc_aldric_secret:
    ...
    menu:
        ...
        "你为什么不告诉我父亲真相？":
            ...
            "你将这个信息深深记在心里。在权谋的棋局中，每一个秘密都是一枚棋子。"
    ...
    "他不再只是一个管家——他是一个老战士，一个忠诚的守护者，一个背负着沉重过去的人。"
...
label npc_captain_past:
    ...
    menu:
        ...
        "如果战争真的来了，你会怎么做？":
            ...
            "你扶起他。从这一刻起，你们之间不仅是主从关系，更是并肩作战的战友。"
...
label npc_elena_past:
    ...
    elena "所以……现在你知道了全部。从十二岁的孤女到今天站在你面前的这个女人——每一步都是别人安排的。"

    "她继续说着，声音平静得不像在讲述自己的故事。"

    elena "直到遇见你父亲。他是第一个问我'你自己想要什么'的人。"

    "她无意识地抚摸着自己的手腕——你隐约看到几道淡淡的旧疤痕。"

    elena "那些任务里的人的脸，我全记得。有时候在梦里，他们会站成一排看着我。不说话，就看着。"

    "她的声音变成了耳语。"

    elena "你知道最可怕的是什么吗？不是那些任务本身。是……你发现自己做完之后，手很稳。"

    elena "一点都不抖。"

    "寂静在你们之间蔓延开来。猫头鹰不知何时已经停止了鸣叫，仿佛整片森林都在屏息倾听。"

    elena "他把我介绍给了暗百合。从那以后，我同时为三方传递消息——但心只有一个方向。"

    elena "你父亲是这个世界上唯一一个……不把我当成工具的人。他对我说：'孩子，你安全了。'"

    "月光在她脸上画出一道银色的弧线，你看到她脸颊上的泪痕。"

    elena "而现在他也不在了。"

    "她终于转过头来看你。那双紫色的眼睛里，藏着深渊般的孤独和一丝脆弱的希望。"
    ...
    menu:
        "你现在安全了，艾琳娜。":
            ...
            "你重复着父亲曾经对她说过的话。简单，却有着千钧之重。"

            player "你不是工具。你是一个在地狱中活下来的人。那些事不是你的选择——你还是个孩子。"

            "你伸出手，轻轻覆上她冰凉的手背。她浑身一颤，像是触电一般——但没有缩回去。"

            player "父亲收留了你，因为他看到了你的本质。不是一个间谍，而是一个受伤的孩子。"
...
label npc_bishop_confession:
    ...
    menu:
        ...
        "证据在哪里？旧遗诏藏在哪里？":
            ...
            $ hide_all_chars()
            "你将羊皮卷、印章、便笺都仔细看过——内容已经牢牢记下，然后合上铁箱，把石块推回原位——墙面重新合拢，没有留下任何痕迹。"
