...
init python:
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 5), ("stat", "reputation", 3)],
                    },
                    "failure": {
            ...
            "choices": [
                {
                    ...
                    "failure": {
                        "narration": "你试图反抗，但刺客的身手远在你之上。几个回合后，你被逼入墙角。\n\n幸好侍卫听到动静赶来，刺客见势不妙，摔了一颗烟雾弹后消失在夜色中。你的手臂被划了一道口子，伤口隐隐发黑——是毒。\n\n经过一夜的紧急处理，你捡回了一条命。",
                ...
                },
                {
                    ...
                    "success": {
                        "narration": "你镇定地坐回椅子，看着刺客手中的匕首。\n\n「暗百合的人？还是男爵的？」你平静地说，「杀了我，对你的主人并没有好处。」\n\n刺客微微一愣。你抓住这个机会继续说：「我知道你们要什么。坐下来谈谈，也许我们能达成共识。」\n\n漫长的沉默后，刺客收起匕首，从怀中取出一封信放在桌上，然后无声无息地消失了。\n\n信上只有一句话：「暴风将至，你只有两条路。」",
                        "effects": [("stat", "intrigue", 8), ("stat", "reputation", 3), ("flag", "assassination_survived", True)],
                    },
                    "failure": {
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", 8), ("stat", "intrigue", 5), ("stat", "reputation", 5)],
                    },
                    "failure": {
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -5), ("item", "medicinal_herbs", 3), ("item", "waterskin", 2)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -8), ("item", "iron_ore", 4), ("item", "leather_scraps", 2)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -3), ("stat", "intrigue", 2), ("item", "medicinal_herbs", 2), ("item", "iron_ore", 2), ("item", "holy_water", 1)],
                    },
                    "failure": {
                        "narration": "你试图压价，但这个商人显然也是个老手。一番唇枪舌剑后，他寸步不让。\n\n最终你不得不按原价购买了一些物资。",
                        "effects": [("stat", "wealth", -6), ("item", "medicinal_herbs", 2)],
                    },
                },
                {
                    "text": "不买了「继续赶路」",
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", 8), ("stat", "intrigue", 5), ("stat", "reputation", 3)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "reputation", 3), ("stat", "faith", 2)],
                    },
                    "failure": None,
                },
            ],
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -3), ("stat", "intrigue", 3), ("item", "dark_lily_extract", 2), ("item", "holy_water", 2), ("item", "leather_scraps", 3)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "reputation", 5), ("stat", "power", 3), ("stat", "loyalty", 3), ("item", "dark_lily_extract", 1), ("item", "iron_ore", 2)],
                    },
                    "failure": {
                        "narration": "你试图抓住蒙面人，但他身法极快，一个翻身就消失在了黑暗中。\n\n你只来得及捡起他掉落的一小包货物。",
                        "effects": [("stat", "power", 1), ("item", "leather_scraps", 1)],
                    },
                },
                {
                    "text": "视而不见「当作没看到」",
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -10), ("stat", "loyalty", 10), ("stat", "faith", 5), ("stat", "reputation", 8)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -3), ("stat", "loyalty", 3), ("stat", "faith", 2)],
                    },
                    "failure": None,
                },
                {
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 8), ("stat", "reputation", 2)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 5), ("stat", "wealth", -2)],
                    },
                    "failure": {
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "faith", 5), ("stat", "intrigue", 5), ("rel", "rel_bishop", 8)],
                    },
                    "failure": None,
                },
                {
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 10), ("flag", "father_letters_found", True)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "stat_req": None,
                    "success": {
                        "narration": "奥尔德里克接过笔记本，老手微微颤抖。\n\n「这确实是老领主的笔迹……」他沉默了很久，然后抬头看着你，眼中有泪光，「少主，你父亲……他在调查一件危险的事。请你务必小心。」\n\n他没有说更多，但你感觉到他知道的比他说的多。",
                        "effects": [("stat", "intrigue", 5), ("rel", "rel_aldric", 8)],
                    },
                    "failure": None,
                },
                {
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 5), ("stat", "power", 3), ("stat", "loyalty", 5), ("rel", "rel_baron", -10)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 8), ("stat", "wealth", -5), ("stat", "reputation", 3)],
                    },
                    "failure": {
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("rel", "rel_elena", 15), ("stat", "intrigue", 5)],
                    },
                    "failure": {
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "faith", 8), ("rel", "rel_bishop", 5), ("stat", "loyalty", 3)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "faith", 5), ("rel", "rel_bishop", 8), ("stat", "intrigue", 2)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "faith", 2), ("rel", "rel_bishop", 2)],
                    },
                    "failure": None,
                },
            ],
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -15), ("stat", "loyalty", 15), ("stat", "faith", 5), ("stat", "reputation", 10)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "wealth", -8), ("stat", "faith", 10), ("stat", "loyalty", 8), ("rel", "rel_bishop", 10)],
                    },
                    "failure": {
                        "narration": "主教派来了修士，但瘟疫的凶猛超出了预期。仅靠祈祷和草药难以完全控制。\n\n最终，你不得不追加投入更多资金才勉强控制住疫情。",
                        "effects": [("stat", "wealth", -12), ("stat", "faith", 5), ("stat", "loyalty", 5), ("rel", "rel_bishop", 5)],
                    },
                },
                {
                    "text": "封锁隔离「牺牲少数保全多数」",
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "loyalty", -10), ("stat", "reputation", -8), ("stat", "intrigue", 5), ("stat", "power", 5)],
                    },
                    "failure": None,
                },
            ],
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "power", 8), ("stat", "loyalty", 3), ("stat", "reputation", -5), ("stat", "intrigue", 5)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 10), ("stat", "loyalty", 5), ("stat", "power", 3)],
                    },
                    "failure": {
            ...
            "choices": [
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "power", 5), ("stat", "intrigue", 5), ("stat", "loyalty", 3), ("rel", "rel_captain", 5)],
                    },
                    "failure": None,
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 12), ("stat", "reputation", 8), ("stat", "power", 5)],
                    },
                    "failure": {
                ...
                },
                {
                    ...
                    "success": {
                        ...
                        "effects": [("stat", "intrigue", 8), ("rel", "rel_elena", 10)],
                    },
                    "failure": {
    ...
    def _get_current_chapter_num():
        """获取当前章节数字"""
        ch = _get_current_chapter()
        mapping = {"第一章": 1, "第二章": 2, "第三章": 3, "第四章": 4, "第五章": 5, "已通关": 5}
