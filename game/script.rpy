...
label arrive_castle:
    ...
    "黑色的旗帜在风雨中沉重地翻卷。城堡的轮廓在阴云下显得格外压抑，那些你儿时觉得雄伟的塔楼，此刻看来更像是一座巨大的墓碑。"

    "马车经过村庄时，你拉开了窗帘。"

    "几个农妇站在茅屋门前，怀里抱着孩子，默默地注视着你的马车驶过。有人朝马车探了探头，又被身边的人拉回去了。"
    ...
    "老人穿着一件深红色的长袍，胸前佩戴着家族骑士的徽章。他的脊背弯了，满脸刀刻一样的沟壑，但那双眼睛还亮着——老猎鹰的眼睛。"
    ...
    "你没有急着走进大厅，而是在庭院中停下了脚步。信上写再多，不如自己走一遍。"
    ...
    "你看得出来，这些人不是训练有素的精锐。他们的铠甲陈旧，有的缺了护肩，有的头盔上有明显的凹痕。但没有一个人低着头。"
    ...
    $ hide_all_chars()
    "老兵没走，站在那儿看了你很久——像是在你脸上找另一个人的影子。"

    "庭院中的所有人都在看着你。仆人、士兵、铁匠、马夫——都在等你开口。"
    ...
    ## 阿威克反馈 (batch 13 #1, 2026-05-11): 玩家觉得"天崩开局 没兵没势没钱没人",
    ## 加一段主角内心清点"我手里有什么", 缓解空壳感. 不改 canon, 只让玩家看见已有的资源.
    $ hide_all_chars()
    "庭院的雨小了一些。你站在那里，视线在老兵的木拐杖、马夫的破棉衣、和铁匠铺斜歪的烟囱之间移动。"

    "很多人会说：你接的是个空壳子。"

    "——可空壳子不会有老兵从墙根阴影里出来认你。空壳子不会有四十岁的总管把你寝室的热水连夜烧好。空壳子不会有一个学徒因为你看了他一眼就吓掉手里的刷子。"

    "父亲留下的不是金山。但你环顾一遍，心里默默清点——"

    "一支装备老旧、却没有溃散的卫队。你认得他们站姿里的东西——那是被人带过的兵。"

    "一个三十年的老管家。这种忠诚不写在账本上，但写在他刚才握你手时手指的颤动里。"

    "一座墙皮斑驳、城门厚实的城堡。北墙的修补痕迹很明显，但城门的铁皮是新换的。"
    ...
    "但比「什么都没有」强得多。至少今晚有热水，有人替你备好饭，有人替你站夜哨。"

    "明天再算账。"

    "内院中，仆人们排成两列，低着头等候。你的目光扫过他们——洗衣妇、马夫、厨娘、园丁。"
    ...
    "画中的父亲约莫三十多岁的样子，正值壮年。他身穿铠甲，佩剑立于城堡之前，嘴角微微上扬，像是什么都不放在眼里。"
...
label great_hall:
    ...
    captain "城堡防务一切正常，领主大人。四十名常备卫兵，随时听候调遣。"

    "四十人不算多。可这些兵甲胄齐整、站姿沉稳，一看就是上过阵、被人正经带过的。艾登堡扼着北境山口，城里养的这点常备兵，个个拉得上城墙、打得了硬仗。"
    ...
    menu:
        "询问卫队的详细情况":
            ...
            captain "人数是不多，可北境不比内地——这四十人里，大半跟边境的马匪、越界的散兵真见过血。摆出去，没人敢小看艾登堡。"
    ...
    "她的声音低而沉稳，不像寻常侍从的嗓子。她的目光直视着你——没有怯意，也没有讨好。"
    ...
    "床头柜上有一个木框的小像——那是你母亲的画像。她在你七岁时病逝，你对她的记忆已随岁月渐渐模糊。但父亲把这幅画像保留了十五年，每天入睡前想必都会看上一眼。"
    ...
    menu:
        ...
        "看看母亲的画像":
            ...
            ## batch 14 反馈"编辑部替补" (2026-05-11) #6 母亲身份伏笔: 加 lore 暗示母亲来历不简单, 但不解开全部秘密 (保持伏笔感)
            "画像的背面贴着一张折叠的小笺，纸边发黄。你犹豫了一下，还是抽出来展开——"

            "是几行没标作者的字，写在某个笔记本撕下来的纸上：「雪在树根处化为水，水在石缝里凿成沟。我离开父亲的城堡那一年，也是这样的春天。」"

            "你不知道母亲说的「父亲的城堡」在哪里。父亲只说过一次——母亲是「嫁过来的，路远」。没说从哪里。没说为什么。"
    ...
    "你默默听着，把每一条信息都记在心里。粮价、猎物、收成——拼在一起，就是艾登堡眼下的处境。"

    "晚宴散去后，人们三三两两地离开了大厅。你注意到一个细节——"

    "主教和艾琳娜在走廊拐角处驻足交谈了几句。两人的表情都很平淡，交谈也很短。但那几句话显然不是在聊天气。"
    ...
    $ hide_all_chars()
    "艾琳娜披着一件深色的斗篷，站在几步之外。月色下，她的面容半明半暗，那双沉静的眼睛映着星光。"
    ...
    elena "另外，两位村长——北村的托马斯和南村的汉斯——坐在一起，但整晚没有交谈过一句话。"
    ...
    menu:
        "感谢她的洞察，询问更多":
            ...
            $ hide_all_chars("player_char_img")
            show player_char_img at left with dissolve
            player "你看得很细。还有什么是我该知道的？"
            hide player_char_img
            $ hide_all_chars("elena_img")
            show elena_img at left with dissolve
            elena "领主大人愿意听，我愿意说。"
            "她的目光柔和了一些，只是一瞬。"
            elena "在这座城堡里，真心向着您的人不多。但存心害您的也没几个。大部分人只是在看——看您撑不撑得住。"
    ...
    menu:
        "追问这句话的含义":
            ...
            "你的父亲不是一个会在防务上犯糊涂的人。他留着那道水门，一定有他的理由。"
    ...
    $ hide_all_chars("captain_img")
    show captain_img at left with dissolve
    captain "十二年了。当年我在外头落了难，是老领主把我收留下来，给了我一碗饭吃、一个容身的地方，又一步步把我提拔到卫队长。"
...
label first_night:
    ...
    "桌上堆满了需要处理的文书——税收报告、军需清单、商路许可、土地纠纷……最上面那份灌溉渠修缮请求，落款日期是去年春天。"

    "翻下去，消息一条比一条糟："

    "税收在下降，北方边境有盗匪出没，粮仓的储量只够撑过这个冬天。"

    "你仔细翻阅着账本。艾登堡的岁入在过去三年里持续减少——而父亲似乎在生命的最后几年里，将大量的金钱花在了某些不明用途上。账目上只简单标注着「特别支出」，没有任何细目。"
...
label after_letter_crisis:
    ...
    "一封来自北疆议会的信，火漆上压着渡鸦纹。希尔达伯爵夫人的人，试探性地问起联姻的可能。"
    ...
    menu:
        "以攻为守——'我们不能被动挨打'":
            ...
            "奥尔德里克点了点头，多倒了一杯酒推到你面前。雷恩的手不自觉地按上了剑柄。"
            hide aldric_img with dissolve
    ...
    captain "领主大人，北方哨所急报——冯·哈根男爵的军队，今早出现在我们的边境上。"

    captain "斥候说人数不少，但具体几何，第二封快马还在路上。他们打着「护送吊唁使团」的旗号——"

    captain "可那阵仗……不像是来吊丧的。"
...
label first_crisis:
    ...
    captain "两百号人压到边境上，哪有这样吊丧的。"

    $ hide_all_chars()
    "两百人。你的卫队只有四十人。就算个个是上过阵的精锐，五倍的兵力压上来，这座石堡也未必扛得住。"
    ...
    aldric "他不敢真打——代价太高。但他会一直往前蹭，蹭到我们退无可退。"
    ...
    $ hide_all_chars()
    "你的拳头在桌子底下攥紧了。才两天。你回艾登堡才两天，就要面对这样的局面。"
...
label crisis_diplomacy:
    ...
    $ hide_all_chars()
    "你花了一个时辰斟酌使者带去的信件，改了三遍措辞——太软像求和，太硬像挑衅。"
...
label after_border_crisis:
    ...
    player "这些我都知道。但男爵今后想动我们，得先掂量这一回的代价。"
...
label crisis_spy:
    ...
    $ hide_all_chars()
    "你按住了想要立刻行动的冲动。两百人对四十人——硬拼不行，但未必没有别的法子。"
    ...
    menu:
        "信任她，让她去":
            ...
            "你看着空荡荡的走廊。你在信任一个你还不了解的人。"
            hide elena_img with dissolve
            "三天后，艾琳娜带回了惊人的消息。"
            "她的衣裙上沾着泥土和草叶，但步子轻快，眉眼间透着一股得意。"
            $ hide_all_chars("elena_img")
            show elena_img at left with dissolve
...
label first_decree:
    ...
    menu:
        ...
        "清剿盗匪，恢复商路|财富+ 声望+ 权力+":
            ...
            "税收开始恢复，但剿匪中损失了五名士兵。"
            "你命人在城门前为阵亡的士兵举办了葬礼，亲自念出每一个人的名字。"
            "而且，有传言说这些盗匪背后有人指使……"
    ...
    menu:
        "坦然接受——'你说的很好，随你汇报'":
            ...
            show elena_img at left with dissolve
            elena "领主大人果然豁达。"
            "她说了句「那我先——」话没说完就转身走了。到门口时回头瞥了你一眼，嘴唇动了动，终究没再开口。"
