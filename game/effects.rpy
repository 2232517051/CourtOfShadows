default ch3_recap_lily_line = "你面临抉择——加入暗百合还是将其捣毁。"   ## ch4 开场回顾的第三章关键行; 爽约路线在 ch3_hq_gate 改写
## ============================================================
## 大厂级演出效果系统
        ...
        vbox:
            ...
            viewport:
                ...
                vbox:
                    ...
                    null height 4
                    text "版本：3.9.4 | 更新日期：2026年9月 | 开发者：FFire的工作室" size 12 color "#6a5e48"
    ...
    _chapter_recaps = {
        ...
        "chapter3": (
            ...
            [
                ...
                "父亲生前与暗百合有着不为人知的联系。",
                "[ch3_recap_lily_line]",   ## 动态: 赴约=默认值; 爽约在 ch3_hq_gate 换成不去版
                "父亲死因的真相逐渐浮出水面。",
            ]
        ),
        "chapter4": (
