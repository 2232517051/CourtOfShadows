...
label npc_captain_war_story:
    ...
    menu:
        ...
        "那场仗最后是怎么赢的？":
            ...
            captain "那一天我才明白，为什么五千禁卫军肯跟着他三天三夜不合眼。"
    ...
    captain "我跟了您父亲十二年，又跟了您。您和您父亲一样，有一种让人愿意为之赴死的东西。"
...
label npc_elena_homeland:
    ...
    if not elena_identity_exposed_known:
        ...
        elena "后来的事你都清楚了——艾登堡，你父亲识破我，还有那句「不该为别人的野心负责」。"
    ...
    "那个在雪中仰头的少女，那个父亲早逝、母亲改嫁后被独自留下的孤儿，那个被迫成为棋子却从未放弃温柔的女人——都是她。"
...
label npc_aldric_promise:
    ...
    menu:
        ...
        "我不确定自己配得上这份传承，但我会努力去配得上。":
            ...
            aldric "这枚徽章在我手里三十年，我也是慢慢才觉得自己配得上它。您有的是时间。"

            "你伸出手，接过了徽章。"

            aldric "请收好它。在您需要力量的时候——不是刀剑的力量，而是坚持的力量——请握住它。"

            "徽章很凉。但你知道它会慢慢被你的体温捂热。"
