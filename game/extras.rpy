...
init python:
    ...
    collectible_items = {
        ...
        "poison_bottle": ("空毒药瓶", "物证",
            "在某个意想不到的地方发现的毒药瓶",
            "一个精致的玻璃小瓶，瓶身刻有炼金术符号。瓶内残留的紫色液体散发着微弱的甜味——这是「暮色之露」毒药的特征。\n\n这种毒药无色无味，溶于酒中后几乎无法被察觉。中毒者会在数月乃至数年内逐渐衰弱，看起来就像自然病亡。"),
...
screen credits_roll():
    ...
    viewport at credits_scroll_anim:
        ...
        vbox:
            ...
            text "北城　栀子　千品　阿威克" size 18 color "#e0d8c8" font "msyh.ttf" xalign 0.5
            text "沈虞舟　洋溢　Måneskin　打遍天下无敌手" size 18 color "#e0d8c8" font "msyh.ttf" xalign 0.5
