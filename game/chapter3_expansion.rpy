...
label ch3_exp_investigation:
    ...
    if lily_full_member:
        ...
        "你决定把暗百合查个彻底。零散的线索太多，是时候把它们串起来了。"
    ...
    $ hide_all_chars("aldric_img")
    show aldric_img at left with dissolve
    aldric "外交稳，就是慢。动兵快，但动静一大，蛇先缩了洞。渗透……收获最大，人也最容易折进去。"
...
label ch3_exp_crime_scene:
    ...
    menu:
        ...
        "标记位置后离开「以后再来」":
            ...
            "你在心中记下了这个位置——那棵劈了半边的老橡树和旁边的石堆——然后悄悄离开。"
...
label ch3_exp_forest_expedition:
    ...
    menu:
        ...
        "在祭坛前冥想「感受这个地方的力量」" if faith >= 45:
            ...
            "守护弱者的利刃翻过手，一样割肉见骨。暗百合走到今天，刃口朝着谁，全看握刀的人。"
...
label ch3_exp_herbalist:
    ...
    "你的心沉了下去。那些失踪的农民——如果他们还活着——恐怕早就成了任人摆布的傀儡。"
    ...
    menu:
        ...
        "请教更多关于毒药的知识" if intrigue >= 45:
            ...
            $ hide_all_chars("player_char_img")
            show player_char_img at left with dissolve
            player "辨毒解毒的本事，我想通学一遍。不仅是暗百合——常见的毒药和解药都教我。"
...
label ch3_exp_cult_infiltration:
    ...
    "铁刺派首领接着抛出了一个计划：在下个月的领主会议上制造混乱，趁机暗杀几位「阻碍正义」的贵族。"
    ...
    menu:
        "继续潜伏「获取更多情报」" if intrigue >= 55:
            ...
            "你还注意到，并非所有人都赞同这个计划。坐在前排的几个人频频侧头低语，身体不自觉地往后缩。"
        ...
        "中途撤离「风险太大」":
            ...
            "虽然没有获得全部情报，但你已经知道了最关键的事——铁刺派计划在领主会议上动手，而且你是目标之一。"
...
label ch3_exp_confrontation:
    ...
    "你把掌握的所有情报铺在桌上：暗百合的据点地图、集会的记录、毒药的配方与解法、父亲的手札。"
    ...
    menu:
        "军事打击「正面摧毁暗百合」":
            ...
            edmund "我叫艾德蒙。你祖父的弟弟。你的……叔公。铁刺派——是我从暗百合中分裂出来的。影主的路线太软弱了。"
        ...
        "政治手段「向王廷举报」" if reputation >= 55:
            ...
            edmund "你父亲从来没告诉过你吧？你祖父有一个被家族除名的弟弟。我从暗百合中拉出了铁刺派——因为影主的手段太温吞了。"
        ...
        "谈判策略「分化瓦解暗百合」" if intrigue >= 58:
            ...
            ## 命名一致性: negotiated 分支全程没报名(名牌终身停在"铁刺派首领"),
            ## 玩家视角的旁白不能未卜先知地喊出"艾德蒙"
            "你通过在集会上观察到的线索，秘密联系上了铁刺派中的温和派成员——那些对首领的极端路线心存不满的人。"
        ...
        "暗中接管「取代首领的位置」" if intrigue >= 60:
            ...
            player "铁刺派一散，底下那些人就是流寇。但如果我能把他们攥在手里……"
            ...
            $ hide_all_chars("player_char_img")
            show player_char_img at left with dissolve
            player "铁刺派有数百号人，眼线遍布城镇乡野。与其消灭它，不如驾驭它。"
            ...
            "奥尔德里克没再多说什么，但接下来几天他对你公事公办，不像从前那样事事先替你想一步。他跟了你父亲一辈子——而你父亲一辈子都在阻止他叔叔做的，正是你刚做的事。"
            ...
            $ hide_all_chars("edmund_img")
            show edmund_img at left with dissolve
            edmund "我是艾德蒙。你祖父的弟弟。我从暗百合中拉出了铁刺派——因为影主太优柔寡断。你们一家人……都与百合花脱不了干系。"
    ...
    "铁刺派的危机暂时过去了。但一个你无法回避的真相摆在面前——"

    "你的祖父有一个被家族除名的弟弟。"

    "他被家族除名，流落在外，最终走上了一条与暗百合正统决裂的路。"

    "而你的父亲，一生都在暗中试图阻止自己的叔叔走向极端。"

    "「他不是为你死的，」你在心中想，「他到死都还在拦着自己的叔叔。」"
