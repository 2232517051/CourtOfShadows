...
label chapter2_start:
    ...
    call show_chapter("第二章", "领主会议", "贵族间的明争暗斗")
    call show_recap("chapter1")
...
label ch2_preparation:
    ...
    aldric "还有西面的施泰因伯爵夫人，她丈夫去年战死，如今独自撑起领地。是个厉害的女人。"
    ...
    menu:
        ...
        "带上全副武装的卫队，以示实力":
            ...
            "雷恩兴冲冲地去挑人了。你看着他的背影，心想：有时候最好的防御就是让敌人不敢进攻。"
    ...
    "如此平常的景象，却让你心中涌起一种复杂的感觉。这里的人不用操心领地的安危，不用应对男爵的野心，不用揣测王后的意图。"
    ...
    menu:
        "主动上前与格雷伯爵攀谈":
            ...
            "格雷伯爵抬起头，带着几分惊讶地看着你。"
            servant "哦？年轻人也识得这部典籍？"
            player "家父的书房里有一部残本。可惜缺了第三卷。"
            servant "你父亲……你是艾登堡的新领主？"
            player "正是。格雷伯爵大人。"
            servant "嗯……令尊是个博学的人。可惜天不假年。"
            servant "年轻人，明天的会议上，老夫有一个忠告给你——"
            servant "少说话，多听。第一次参加会议的领主，最容易犯的错就是急于表态。"
            player "多谢伯爵指点。"
            servant "不是指点，是老人家的唠叨。哈哈。"
    ...
    menu:
        "上去打个招呼":
            ...
            servant "哈！你就是老艾登堡领主的儿子？"
            servant "令尊可是个倔脾气的人——每次开会都要和男爵吵个天翻地覆。"
            servant "你呢？你是站你爹的队，还是打算走自己的路？"
            player "我来会议是为了所有人的利益，不是为了站谁的队。"
            servant "哈哈哈，说得好！来，喝一杯！这是我领地出产的红酒，王都里都卖疯了！"
    ...
    servant "嗯。我见过你父亲几次。他是个好人——这在贵族里很少见。"

    servant "希望你也是。这个世道，好人活得不容易。"
    ...
    servant "……从前，有一座花园。花园里长着一朵最美的百合花。"

    servant "所有人都说，那朵百合花是花园里最纯洁、最高贵的——白如初雪，香飘十里。"

    servant "于是国王想摘下它，戴在王冠上。"

    servant "但百合花说：'我只在泥土里才能活。你把我摘下来，我就会枯萎。'"

    servant "国王不听。他摘下了百合花，戴在了头上。"

    servant "三天之后——百合花枯了。"

    servant "但奇怪的是，国王也开始枯萎。他的头发变白了，皮肤干裂了，力量一天天流失。"

    "老人停顿了一下，扫视着围观的人群，目光在你脸上短暂地停留了一瞬。"

    servant "国王这才明白——百合花不是花园的装饰，而是花园的根。没有了根，花园就会死去。"

    servant "可是已经晚了。百合花碎成了粉末，从王冠的缝隙里飘散，落在了花园的每一个角落。"

    servant "从那以后，花园里长出了无数朵百合花。它们不再是一朵，而是千千万万朵。"
    ...
    menu:
        "去和说书人攀谈，打探故事的来源":
            ...
            servant "年轻人，好故事不问出处。问的人太多了，故事就变了味。"
            player "那我换个问法——这个故事想说的是什么？"
            servant "说的是权力。"
            "老人的声音突然变得很轻，像是在自言自语。"
            servant "权力就像那朵百合花。你想拥有它，就必须让它长在泥土里。拔起来戴在头上——你和它一起死。"
            servant "真正聪明的人不会去摘花。他会去做花园的泥土。"
            "你沉默了片刻。这个看似普通的老人，说出的话却字字扎心。"
            player "多谢指教。"
            servant "不敢当。老朽只是个讲故事的人。"
            "他笑了笑，拾起碗里的铜板，背着琴慢慢离开。你望着他的背影，觉得这个人远不像表面上那么简单。"
...
label ch2_council:
    ...
    menu:
        ...
        "针锋相对——『男爵大人上次带了两百人来给家父吊唁，这份厚礼我还没来得及回报。』":
            ...
            baron "你——！"
            "格雷伯爵轻轻咳了一声，出面打圆场。"
            servant "年轻人有锐气是好事。但这里是议事厅，不是校场。各位，我们开始正事吧。"
...
label ch2_oppose_tax:
    ...
    servant "既然多数领主反对，那就依惯例联名上书吧。但老夫希望用词温和一些——毕竟，我们不是在宣战。"
...
label ch2_compromise_tax:
    ...
    servant "这个提议有道理。我的领地遭了旱灾，如果王室能用税款来修复灌溉渠，我可以接受新税法。"
    ...
    servant "年轻人的提议确实可行。关键在于——王后是否会接受监督委员会的存在。"

    baron "……好。如果你能说服王后接受这个条件，我可以考虑。"

    "男爵的语气虽然勉强，但你看得出来，他对你的印象改变了——也许不是好感，但至少是某种尊重。"
...
label ch2_after_council:
    ...
    show merchant_karl_img at center with dissolve
        ...
        "先听听他的消息":
            ...
            menu:
                ...
                "拒绝":
                    ...
                    merchant "如果领主大人改变主意，随时来找我。我在哈伦堡还会待几天。"
...
label ch2_ambush_prepared:
    ...
    menu:
        "交给雷恩审讯":
            ...
            "雷恩的眼中闪过一丝冷意。他把俘虏拖到一边，消失在树林的暗影中。"
            "不久后，你听到了一声压抑的惨叫。"
...
label ch2_end:
    ...
    ## 章节结束统计
    call show_chapter_summary("第二章", "领主会议")
    ...
    "老骑士的语气异常沉重。你从未见过他这个样子——像是一个背负了太多秘密的人，终于到了不得不开口的时刻。"
    ...
    menu:
        "向艾琳娜敞开心扉——『有时候，我真的不知道自己能不能扛住。』":
            ...
            "壁炉里的火光在她的眼中摇曳。那一刻，你觉得她不像王后的密探，不像精于权术的侍从——"
            "她只是一个在深夜里握着你手的人。"
    ...
    "你回到书房，在壁炉前坐下。火光映在你的脸上，那道新鲜的伤痕在暖光中显得格外醒目。"
    ...
    "脑海中浮现出今天发生的一切——领主会议上的唇枪舌剑、商人卡尔那双精明的眼睛、林中的伏击、黑衣人手腕上的百合花纹身……"

    "还有艾琳娜。她那句莫名其妙的话——'如果我做了什么让您不理解的事，请相信，我有我的理由。'"

    "她在暗示什么？她是否知道伏击的事？她是否提前得到了某种消息？"

    "你摇摇头，把这些念头暂时压下。现在最重要的是休息。明天还有很多事要处理。"
    ...
    "她走进来，在你对面坐下。壁炉的火光映在她的脸上，让她的轮廓变得柔和了许多。"
    ...
    "银白色的月光洒满大地，树影斑驳，像是无数只窥探的眼睛。"

    if father_death_known:
        "磨坊……那封信约你满月之夜去磨坊。"
        "今夜就是满月。"
        "你看着那轮悬在天边的满月，脑海中浮现出信上的字迹——'若想知道真相，满月之夜，独自来磨坊。'"
        "你攥紧拳头。不管那里等待你的是陷阱还是答案——你都必须去。"

    "远处，城堡的钟楼响起了午夜的钟声。十二下沉闷的回响，在寂静的夜空中久久不散。"

    "你在黑暗中回想着这次旅程。"

    "从艾登堡出发时，你只是一个即将参加第一次领主会议的新人——紧张、忐忑，甚至有些手足无措。"

    "而现在，你带着一道伤疤、一份盟约（或敌意）、一个商人的消息、和一连串悬而未决的谜题回来了。"

    "你学到了一些东西。在那张圆石桌旁，你看到了权力的真实面目——"

    "它不是盔甲和利剑，不是金币和粮草，而是人心。"

    "谁能看透人心，谁就能掌控棋局。"

    "你的父亲显然深谙此道。但他也未能逃脱棋局的反噬。"

    "如果连他都倒下了——你能走多远？"

    "你没有答案。但你知道一件事：退路已经没有了。"

    "从你坐上那把石椅的那一刻起，你就再也不是一个旁观者了。你是棋手，也是棋子。"

    "你唯一能做的，就是比对手多看一步。"

    "你闭上眼睛。一个月前，你还只是一个从王都匆匆赶回的年轻人。"

    "如今，你是一个有盟友、有敌人、有秘密、有伤疤的领主。"
