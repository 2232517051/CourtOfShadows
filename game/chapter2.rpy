...
label chapter2_start:
    ...
    ## 下面 first_decree 的四个分支保留不动: 政令是第一章下的, 效果自己长出来, 不冲突。
    ## 没亲自去(delegated)的玩家人一直在艾登堡, 走原句。
    if southern_outcome not in ("none", "delegated"):
        "奥尔德里克随第一船盐先你一步回了艾登堡。这一个月他一边盯着卸盐入库一边把领地的事扛了下来——秋税尾款催齐了，冬储没耽误。回来后你才看出他瘦了一圈。"
...
label ch2_preparation:
    ...
    menu:
        ...
        "带上全副武装的卫队，以示实力":
            ...
            "雷恩兴冲冲地去挑人了。他铠甲上的铁扣还没扣好就跑了出去——这家伙永远比你更急。你摇了摇头。"
    ...
    $ hide_all_chars()
    "人群中有人鼓掌，有人往老人面前的碗里扔铜板。但你站在原地，没有跟着鼓掌。"
...
label ch2_council:
    ...
    "厅内的光线来自高处的彩色玻璃窗。冬日的阳光透过玻璃，在石桌上投下斑驳的色彩——红色、蓝色、金色，交错在一起。"

    "你深吸一口气，推开了议事厅那扇沉重的橡木大门。门轴发出低沉的吱呀声。"
...
label ch2_after_council:
    ...
    if karl_past_done:
        merchant "领主大人，又见面了。"
        "依旧是那身朴素的旅行装束。你想起暮色集市上他独自摩挲那枚温特菲尔德徽章的样子。"
    elif karl_met:
    ...
    $ hide_all_chars()
    "空气里留下一缕淡淡的草药味——是她衣服上常有的那种。你站了一会儿，说不清在等什么。"
...
label ch2_assassination:
    ...
    "队伍在星光下离开了哈伦堡的城门。清晨的空气冷得像刀子，吸一口气，肺里隐隐发疼。"
    ...
    if intrigue >= 45 or (rel_elena >= 15 and spy_network):
        ...
        "树林太安静了——没有虫鸣，没有夜鸟。连风声都突然消失了。"

        "你的后颈汗毛倒竖。王都的兵法课上，教官管这种感觉叫杀气。"
...
label ch2_ambush_prepared:
    ...
    "袭击者训练有素——他们从树上跳下，无声无息地扑向你的卫兵。动作迅捷凶猛。"
...
label ch2_end:
    ...
    if father_death_known:
        ...
        ## 外章 · 南境: 交代"为什么拖到这一轮满月"—— 上一个满月他人在南边。
        ## script.rpy 第一章末"满月之夜就要到了"约的就是这封信, 而这里已经"一个月过去了"。
        ## 月相周期约 29.5 天, 所以"今夜就是满月"本身没错(是下一轮), 缺的只是他为什么没赶上
        ## 第一轮 —— 南下正好填这个。
        ## 只加入场交代, **不动纸条内容和后续剧情**: 这不是惩罚, 也不该让他错过任何情报。
        if southern_outcome not in ("none", "delegated"):
            "你去南边的时候，那个满月就过了。"
            "信里约你的人等了一夜。你没去。"
            "你从箱底把信翻出来，折痕快把纸磨穿了。晚了一个月——但你得去看一眼。"
        else:
            "今夜就是满月。"
