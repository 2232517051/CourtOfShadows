...
label ending_peoples_epilogue:
    ...
    "几个急着清理旧债的领地先接受了公开账目，查出仓吏和包税人的亏空。列席权仍被拖延；另一些领主在收成好转后撤下公示牌，赶走村社代表，拒缴地租的冲突又起。"
    ...
    if dark_lily_joined:
        "暗百合内部为是否公开身份和档案争论了多年。一部分成员成为公开监察员，另一部分离开；艾登堡后来的地方议会只要求监察员公开经费和案卷，没有强迫所有人接受同一种去处。"
    elif dark_lily_destroyed:
