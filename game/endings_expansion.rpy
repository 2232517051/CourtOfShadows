...
label ending_epilogue_router:
    ...
    if ending_type == "truth":
        ...
        jump ending_vassal_epilogue
    elif ending_type == "fall":
        jump ending_fall_epilogue
    elif ending_type == "sea":
        jump ending_sea_epilogue
    else:
        return

## ============================================================
## 结局七：附庸领主 - 扩展尾声「附庸的年月」(backlog7)
## ============================================================

label ending_vassal_epilogue:
    ...
    "王都的文书还是每旬一批。你已经练出了本事：扫一眼措辞，就知道这回是例行公事，还是有人在王都替你上了眼药。"

    "书房抽屉里锁着那份协约。你每年开春拿出来读一遍——三条还是三条，一个字没多，一个字没少。"

    "多出来的东西都在纸外面：收税的季度上门，驻军名额的岁末核点，还有王都来客那种打量藩属的眼神。"

    "但艾登堡五年没见过兵灾。半编的守军没打过一仗。这是那个签名换来的另一半。"

    if built_granary:
        "每年两次纳贡，粮从山上那座大粮仓出。仓是满的，账是平的，收税官掂着秤也挑不出错。"

    if famine_prevented:
        "河谷的人每年新麦下来，都先给城堡送两袋。没人组织过这件事——他们记得大旱那年没饿死一个人。"

    "第三年，收税的队伍换了个头目。年轻，佩新剑，进门就说王都定了新规矩，贡额加三成。"
    ...
    "那天晚上奥尔德里克说，城里人在传这件事，越传越像戏文。"

    "你没觉得自己做了什么了不起的事。你只是把纸上的三条守住了——附庸的日子，能守住的东西就这么多，所以一条都不能让。"

    pause 1.0

    scene bg castle_garden with dissolve

    "花园里母亲的藤蔓爬满了半面墙。孩子们还是叫你领主大人，虽然城门上的旗有两面。"

    "你偶尔会想，那个没签字的自己会过什么日子。想不出来。可能睡得更硬气，也可能睡在土里。"

    scene black with fade

    centered "{size=+8}附庸领主 · 尾声{/size}"
    centered "「史书写艾登堡：纳贡称臣，四境无兵。」"
    centered "「城里的孩子只记得，那些年集市每天都开。」"
...
## ============================================================
## 结局八：艾登堡陷落 - 扩展尾声「城破之后」(backlog7)
## ============================================================

label ending_sea_epilogue:
    ...
    if corsair_romance and not marriage_route:
        ...
        "城还在。人还活着。末尾一行：'你的信我收了。戒指替你留着。'"

        "你读了三遍。折好，放进口袋——那截绳头旁边。"
        ...
        if rel_corsair >= 80:
            "那天晚上你睡不着。她也没睡。你伸手握住她编绳的手——绳结硌在掌心中间。"
        ...
        "你从一个港换到另一个港，靠修补铁器和打零工过活。"

        "船员叫你「北佬」。你没纠正。"

        "你的手越来越粗。口音还在——偶尔有人问你是不是贵族出身。你说不是。"

        "某个南方小港靠岸补给。码头上有人说北边在打仗，又有人说在和谈。你分不清真假。"

        "有一天遇到一个北方来的皮货商。你走过去，又退回来，再走过去——艾登堡还在吗？"

        "商人说好像听过那名字。说没打起来，有个管事的很能干，两边都拦住了。「叫什么里克来着……」他挠了挠头，没想全。"

        "你说谢谢。走出几步的时候眼睛酸了一下。海风很大，吹一吹就过去了。"

        "后来你在一座不知名的海港城落了脚。找到一间招短工的铁匠铺。"

        "铁匠看了看你的手——没有茧。但还是让你留下了。"

        "你住在铺子后面的阁楼上。窗户朝海。夜里能听见浪打堤坝的声音。"

        "你用第一个月的工钱买了一套旧工具。锤子、钳子、磨石。夜里擦这些东西的时候，你会想起一些事情。然后不想了。"

        "你没有给任何人写信。不知道写给谁，也不知道该说什么。"

        "你只是活着。像一枚掉进大海的金币——还值那个价，但没人来兑。"

    return


label ending_fall_epilogue:

    scene black with fade
    pause 1.0

    centered "{size=+10}那年冬天{/size}"

    pause 1.5

    scene bg castle_exterior with dissolve

    "大火烧了三天。第四天下了雪，把没烧完的也压熄了。"

    "王后军没有留驻——一座烧过的边城，对王都不值一个营的军饷。男爵军装满大车就走了。"

    "两面旗都没有升起来。艾登堡第一次不属于任何人。"

    if built_watchtower:
        "城破前夜，北岗望楼的烽火亮了最后一次。守楼的人没等到回令就点了火——那半个时辰，让南城两条街的人出了城。"

    if famine_prevented:
        "出逃的人往河谷去。村子开了门，一家分几个，草棚挤一挤总有地方。"

        "没人说原因。大旱那年的账，河谷人自己记得。"

    if rel_captain >= 40:
        "后来的说法是，有个老兵带着十几个残卒，护着难民走完了去西谷的最后一段路。有人说他戴着队长的肩章，也有人说没看清。"

    if elena_romance:
        "还有人提过，西谷的岔路口站着一个灰斗篷的女人，见人就指那条能走的道。天亮之前她就不在了。没人知道名字。"

    pause 1.0

    "开春的时候，有几户人回来了。他们在城墙根下翻地、下种，就像墙还立着的时候一样。"

    "庄稼不管旗子。"

    scene black with fade

    centered "{size=+8}艾登堡陷落 · 尾声{/size}"
    centered "「史书只有一行：是年春，边城艾登堡废。」"
    centered "「领主的名字，抄书的人没有写。」"
...
label ending_decision_pause:
    ...
    ## 赛琳(外章 · 南境)。她与艾琳娜互斥(chapter4.rpy:2532), 但此前在第五章和八个结局里
    ## 一个字都没有 —— 玩家为她拒掉了艾琳娜, 然后她四章零字、八个结局零收尾。
    ## **她不能像艾琳娜/英格丽那样上城墙**: 潮汐港离艾登堡四天山路 + 五天水路, 她是海上的人,
    ## 而这场仗在内陆。所以她的"在场"靠随身那截渡鸦号的缆绳死结; 而 fall 线(玩家拿她的港
    ## 换了自己的盐路特许)用**同一个位置的空缺**来讲 —— 绳结不在了。
    elif corsair_romance:
        $ hide_all_chars()
        if southern_outcome == "fall":
            "风从南边来。你转了个身，背对着南边。"

            "口袋里以前有截缆绳头。渡鸦号上的。你不记得什么时候弄丢的——也许没丢，也许是自己扔的。"

            "南边没什么好看的了。港没了，公会散了，渡鸦号最后出港的消息是路过的盐商随口提的。你没追问。"

            "明天那帮人会从北门进来。你得想这个。"

            "你把手从口袋里抽出来。空的。"

            "城墙底下有人喊了一嗓子，催搬箭的快点。你没低头看。"
        else:
            "风从南边来。你在城墙上站了一会儿，发现自己没看北边的敌营，一直在看南边。"

            "艾登堡看不见海。四天山路，五天水路。你不是没算过。"

            "口袋里那截缆绳头硌着大腿根。渡鸦号上剪下来的，她塞给你的时候什么也没说。打了个死结，意思是不散。"

            "你没拿出来。也没必要。它在那就行了。"

            "明天的事翻来覆去想了二十遍。再想也想不出新花样。"

            "南风干冷，带着山那边的土腥气。到不了海。"

            "你站着。看南边。城墙底下有人在搬最后一批箭。"
...
label ending_truth_epilogue:
    ...
    if prince_ally and not prince_betrayed:
        ...
        prince "各位爱卿，南北两方的争端拖了三个月。朕要一个了断。"
        ...
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        player "陛下，臣以为，争端的根子不在价钱——南北两头都蒙着眼睛喊价。"

        player "南方商会不知道北方的开采成本，北方矿主不了解南方的市场行情。"

        player "不如把两边管事的人召到一处，摊开账簿当面对——"

        player "矿上的工钱、路上的脚力、南边的售价，一笔一笔摆在明处——"
        ...
        if prince_mentor_known:
            ...
            $ hide_all_chars("player_char_img")
            show player_char_img at left with dissolve
            player "西里尔教过臣一句话——学问不认主人。陛下这么做，他不会意外。"

            hide player_char_img
            $ hide_all_chars("prince_img")
            show prince_img at left with dissolve
            prince "犯了最后那一步的错，不等于前面全走歪了。这也是你教会朕的。"
        ...
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        player "南北争端，根子是一笔糊涂账。"
        player "我提议召南北两边管事的人到一处，成本和利钱当面对清。"
        player "账摊在台面上，手脚干不干净一目了然。"

        $ hide_all_chars()
        "委员们纷纷点头。五年来，你用「透明」二字治理这个国家，成效有目共睹。"
        "伸手的官少了，交税的铺子多了，集市上骂朝廷的声音也小了些。"
    ...
    if elena_romance:
        ...
        $ hide_all_chars()
        "你苦笑着摇头。当年在暗巷里替你递消息的姑娘，如今管着半个王国的眼线。"
        "也是你的妻子。"
    ...
    if baron_peace_path:
        ...
        if prince_ally and not prince_betrayed:
            "法庭的审判持续了三天。最终的判决交给了弗雷德里克国王。你不知道结果——但该知道的，他们都知道了。"
        else:
            "法庭的审判持续了三天。最终的判决交给了摄政议会。你不知道结果——但该知道的，他们都知道了。"
    ...
    if dark_lily_joined:
        ...
        "它被迫解散。但如果一个不再需要暗影的世界真的来了——那也许正是暗百合当初想要的。"

    "雷恩留在了艾登堡。审判、清算、改制——这些都不关他的事。"

    "他说过一句话，后来在军中传开了：「谁当政我不管，城墙上的岗，一班都不能空。」"

    if rel_captain >= 60:
        "你把城防的印信正式交到他手上。十二年前他被人从北方的雪地里抬回来，如今整座城的墙都归他守。"
...
label ending_iron_epilogue:
    ...
    if ch5_exp_baron_response == "blackmail":
        ...
        "他至今不知道，你从他自己写的那封威胁信中读出了军事部署。他的狂妄，反倒成了自己的催命符。"
    ...
    if dark_lily_joined:
        ...
        "他们不再为理想服务，只为你服务。这是铁腕之下唯一被允许存在的阴影。"
    elif dark_lily_destroyed:
...
label ending_shadow_epilogue:
    ...
    if dark_lily_joined:
        ...
        lily_master "你做到了我做不到的事——你让这些影子有了章法。"
    ...
    if baron_peace_path:
        ...
        "他不知道的是，他身边的管家、他的信使、甚至他最宠信的副官——都在向你汇报。不声不响地收紧套索，是你最擅长的手法。"
    else:
    ...
    if prince_betrayed:
        ...
        "你放出一条条真假掺半的消息，一步步将他逼入死角。退路被堵死，盟友被策反——最后他「自愿」退出了权力角逐。"
        "他以为是命运弄人。"

    "还有队长雷恩——棋盘上唯一一枚你从不当棋子用的棋子。"

    if rel_captain >= 60:
        "他隐约察觉过。有一次他在校场上问你：「大人，最近城里那些事……和您有关吗？」你说没有。他看了你很久，然后说「属下明白了」，再没问过第二次。"
        "他守他的城墙，练他的兵。你把艾登堡明面上的刀，完整地留给了他。"
    else:
        "你给他加了饷，扩了编。他管刀剑，你管暗处——两不相问。"
        "一个不问问题的武人，是阴影最好的邻居。"
...
label ending_faith_epilogue:
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "你们即将宣誓成为真理骑士。这两个字不是挂在嘴上的——"

    player "是刻在骨头里的。从今天起，到你们合眼的那天。"
    ...
    "这不是一座普通的教堂。"
    "南方请来的石匠垒起高耸的尖塔，本地木匠做了温暖的木质内饰——这片土地上还没人这样盖过教堂。"
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "东翼的穹顶还要再加固。冬天雪大，压塌了可不是闹着玩的。"
    ...
    ## 赛琳(外章 · 南境)。艾琳娜/英格丽都是当场递手帕说俏皮话, 而赛琳不在场 ——
    ## 她的"出现"靠从南境寄来的东西; fall 线(玩家卖了她的港)用同一个位置的空缺: 什么都没寄。
    elif corsair_romance:
        hide player_char_img
        $ hide_all_chars()
        if southern_outcome == "fall":
            "你蹲在地基旁边抹灰浆。脸上糊了泥，没人讲。"

            "盐是从南边运来的——你签的那条路。拉盐的车夫不认识你，你也没搭话。"

            "没有什么南境来的木料。没有油纸条。"

            "你拿袖子蹭了一把脸。继续抹。"
        else:
            "你蹲在地基旁边，拿灰刀往石缝里抹浆。脸上大概也糊了一层——身边没人说你。"

            "工地外有人卸了两车木料。南境来的，没有发货单，没有收件人。搬运的人说船从潮汐港出发，在河港转的陆路。"

            "木料底下压着一张油纸条。字大得像写给瞎子看的，一行："

            "「柱子别用松木。」"

            "没有署名。不用署。"

            "你把纸条折了两折，塞进围裙口袋，跟那截绳结挤在一起。"
    ...
    menu:
        ...
        "\"答案在你自己心里。\"":
            ...
            $ hide_all_chars("player_char_img")
            show player_char_img at left with dissolve
            player "那也没什么。自己想明白的，比别人教的牢靠。"

            player "只有一条——想到什么就去想，别缩回去。"
    ...
    "和平不是没有痛苦。但痛苦之后，日子还能往下过——这就够了。"

    "你慢慢走下台阶，朝着正在建造中的大教堂的方向走去。"

    "它还没有完工。脚手架还在，工人们的喊声从塔顶传下来。"

    "你站在工地外面看了一会儿。一个老石匠正在凿一块拱门用的石头，手里的凿子敲三下停一下，节奏稳定。"

    "再过五年，这座教堂可能还在建。老石匠可能等不到完工那天。"
    ...
    if prince_ally:
        "在教会的庇护下，他重新开始学习治国之道——不是宫廷里那套，而是走到人面前去听、去谈、去让步。"
        "他偶尔会写信给你，问一些关于信仰和责任的问题。那些信越来越成熟。你看到了变化的可能。"
    else:
        "他主动请求去西部边境领地。那里贫穷、偏远，但没有阴谋。"
        "他说他想赎罪。能不能做到是另一回事——至少他走出了王城。"
    ...
    if rel_aldric >= 50:
        "你没有批。你把他的职衔从管家改成了「顾问」——不用早起，不用站班，只在你拿不准的时候来喝一盏茶。"
        "他嘴上说这是变着法子留人，茶倒是一次没缺席过。"
    else:
        "这一次你批了。他回了城郊的老宅，照料他妻子留下的那小片葡萄园。"
        "每年新酒下窖，他都会让人给城堡送两桶。"

    "雷恩的军队在裁撤名单上——和平不需要那么多长矛。"

    "他没有抱怨。他把裁下来的老兵一个个安置好：会写字的去了商队，手稳的去了猎户行会，剩下的编进了巡防队。"

    "做完这些，他才来找你交还佩剑。你让他留着——「巡防队总得有人管。」他应了。"
...
label ending_peoples_epilogue:
    ...
    "最后一车麦子进仓时，赶车人拔下车辕上的草穗，插在了公示牌顶上。"

    "广场已经支起长桌。面包从烤炉里往外搬，苹果酒开了第一桶。谁家的活先做完，谁就先占到靠近提琴手的位置。"

    if wealth >= 60:
        "商队愿意在艾登堡过夜，集市沿着城墙多摆了一排摊位。领库也终于有余钱，能把桥和屋顶一处处补完。"
    else:
        "这里远称不上富庶。税收仍紧，歉收时仍得挨户核算口粮。集市能按期开门，田里的收成也足够把丰收节办起来。"

    if built_granary:
        "公仓门上挂着公开的收支牌。哪户领了几袋、仓里还剩多少，都写在上面；字被雨洇了，账房便重新描一遍。"
    else:
        "新公仓一直没能建成。各村只能把旧仓补了又补，分开存粮；遇到坏年景，谁先开仓仍会吵上一场。"

    "今天没人来催欠账。账房自己搬了条凳子坐在酒桶边，印章还挂在腰上。"

    "你换下礼服，端着木杯站在人群外。一个刚跳完舞的农妇把杯子塞给丈夫，朝你招手。"
    ...
    "她丈夫在圈外笑得最大声。你总算转完一圈，鞋跟沾满了打翻的酒。"

    if built_school:
        "学堂的孩子在长桌边替人写纸条。有人要写祝福，有人只想把欠自己的酒记清楚。"

        "一个女孩追上你，递来一张折得方方正正的纸。上面先写了你的名字，下面又挤着一行小字：『东村借了西村两把镰刀，收完麦子要还。』"
        ...
        $ hide_all_chars()
        "女孩把纸抢回去，说还少了借镰刀人的手印。她钻进人群找人去了。"

    if built_clinic:
        $ hide_all_chars()
        "诊所新馆也在今天开门。门前没有彩带，只有一张碍事的长凳和几个排队看病的人。"

        $ hide_all_chars("healer_img")
        show healer_img at left with dissolve
        healer "正好。把那张凳子往墙边挪挪，担架过不去。"

        hide healer_img
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        player "新馆开门第一天，你就让我搬凳子？"

        hide player_char_img
        $ hide_all_chars("healer_img")
        show healer_img at left with dissolve
        healer "不然呢？病人可不会因为领主站在门口就少疼一会儿。"

        hide healer_img
        $ hide_all_chars("player_char_img")
        show player_char_img at left with dissolve
        player "有道理。顺便替我看看膝盖，刚才跳舞扭了。"
    ...
    if elena_romance:
        $ hide_all_chars()
        scene bg village with dissolve
        "广场边的苹果木牌松了一颗钉子。艾琳娜踩着长凳扶住牌角，几个孩子在下面七嘴八舌地指挥。"
        $ hide_all_chars("elena_img")
        show elena_img at left with dissolve
        elena "来得正好。扶住这边。"
        if rel_elena >= 50:
            ...
            $ hide_all_chars("elena_img")
            show elena_img at left with dissolve
            elena "那你扶稳些。刚才有个孩子差点让它砸到脚。"
            "她从长凳上跳下来，确认木牌不再摇晃，便牵住你的手。"
            elena "走。下一支曲子归我们。"
        else:
            elena "可以了。孩子们还缺一个领舞的人，您去吧。"
            "她替你拍掉肩头的木屑，又回身收拾锤子和钉子。你独自走向舞圈。"
        hide elena_img with dissolve
    elif marriage_route:
        $ hide_all_chars()
        scene bg castle_exterior with dissolve
        $ hide_all_chars("ingrid_img")
        show ingrid_img at left with dissolve
        "城堡门前，英格丽正在核对北境来客留下的礼单。门房接过她的披风，问晚饭照旧摆在哪里。婚后五年，她在这里有自己的房间、钥匙和随员，北疆的家书也直接送到城堡。"
        if marriage_warm:
            ingrid "外面还有最后一支舞。你若想学，我可以再教一次。"
            "散场后，她挽着你的手穿过城门。门厅里，两双沾了泥的鞋并排留在地毯外；谁也没急着叫人来收。"
        else:
            ingrid "北境的客人已经离城。礼单和回函都在书房，明早请您过目。"
            "回城时，你们一前一后穿过同一扇门。她走向自己的房间，厨房照惯例把晚饭摆在长桌两端。"
        hide ingrid_img with dissolve
    elif corsair_romance:
        $ hide_all_chars()
        scene bg village with dissolve
        ...
        scene bg castle_exterior with dissolve
        $ hide_all_chars()
        "丰收节散场后，门房一家仍围在炭盆边分最后一块节饼。值夜的书记抱着睡着的儿子来换班。"
        "他们见你经过便要起身。你摆手让他们继续，随后独自上楼；门厅里的笑声没有停。"
    ...
    "领头的管事把几本税账放上桌。书脊换过，封面上还留着受潮后翘起的痕迹。"

    "\"领主大人，克恩伯爵派我们来向您请教治理之道。\""

    "\"田租越来越难收，商队也在绕路。伯爵让我们来问，艾登堡用了什么办法。\""

    if wealth >= 60:
        "\"这里也打过仗，如今商路却恢复了，领库还有钱修桥。\""
    else:
        "\"这里并不富裕，可村子没有继续空下去，税也还收得上来。\""

    "\"伯爵问，第一步该做什么。\""

    "你翻开最上面一本。每页都有应收总数，村名下面却大片空着。"

    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "这本账上只有总数。你们平时就凭这个收租？"
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "我问的不是该交多少。去年哪村欠收，哪段路被劫，哪个税吏多收过一遍——这里都没有。"
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "先回去把这些空处补上。账补齐了，就把每村收了多少、花到哪里贴出去。错一笔，改一笔。"
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "查到谁藏粮，就向谁追缴。别为了一个人的假账，把整村人的粮都搬走。"

    player "村子争水，就把地界、出工和用水时辰摆到同一张桌上。艾登堡为这些事吵到今天，也没找出一句话就能解决的办法。"
    ...
    $ hide_all_chars("player_char_img")
    show player_char_img at left with dissolve
    player "那就请他带着这些账去一趟收不上租的村子。看过以后，他自然知道该先改哪一笔。"
    ...
    "第二天黄昏。代表团离开后，为期两天的丰收节也到了尾声。"

    "收摊的人把空木盘摞在路边。地上全是麦秆、果核和踩烂的彩带，明早还得有人来扫。"

    "\"[player_name]，晚上好！\""
    "\"[player_name]，尝尝今年的新酒！\""
    if built_school:
        "\"[player_name]，我家闺女会写名字了！她还替我看懂了收粮的账！\""
    else:
        "\"[player_name]，我家闺女跟修士认了字，刚会写自己的名字！\""

    "叫你名字的人多，叫头衔的人少。有人递酒，也有人隔着半条街提醒你，西边那段路还没修完。"

    "面包店正取出最后一炉面包。街对面的铁匠扶着儿子的手腕，教他把第一把锄头敲直。"

    if governance_education >= 20:
        "布告栏前围着几个人。一个半大孩子念新贴的收支，念到修桥的数目时，旁边立刻有人问为什么比上月多。账房被堵在中间，翻着底稿解释。"

    "街角坐着一个白发老妇，脚边放着一篮刚出炉的面包。你认得她。刚继承领地的那个冬天，她丈夫去世，家里连面包都没有；你曾在她桌上留下一袋银币。"

    "她也认出了你，从篮里拿起一块面包。"

    "\"用今年的新麦做的。您拿一块。\""

    "你接过面包。外壳还是温的，指尖沾了一点面粉。"

    "\"往年新麦先拿去抵租。今年交完，还剩了这一袋。\""
    ...
    "是粗面，没放黄油。你吃完一半，把剩下的包进手帕。老妇坐回椅子上，低头数篮里还剩几块。"

    "天黑前，你带着半块面包回到城堡。大厅里已经摆好几张水渠图，账房在旁边等着。"


    ## —— 第五幕：晚年与远讯 ——

    "后来，广场上的账册换了一本又一本。你的头发白了，亲自出门丈量田界的次数也少了。"

    "一封王都来信送到书房时，封口已经裂开。随信抄来的提案上，挤着城镇行会、村社推举的代表，以及少数愿意公开账目的小领主的签名。"
    "纸上只有两项要求：公开地租与税款去向，让村社代表列席地方议事。"
    "第二封信只有半页：贵族席否决了提案。负责抄印、在市集请人按印的人被控『煽动抗税』；名单写到纸背，圈起的名字进了牢房。"
    "后来送来的不再是一份厚提案。城镇行会把提案拆成两份，一份只谈账，一份只谈列席。艾登堡的收支抄本仍附在后面，纸边被翻得起毛。"
    "有些领地先接受了公开账目，仓吏和包税人的亏空这才对得上。村社代表列席议事的提案仍被搁置。另一些来信说，领主撤下公示牌、赶走代表，地租收不上来时又把卫兵派进村子。"
    "你把每封信按日期压在艾登堡的账册下面。第二天，桌上仍是田界、欠税和没修完的路。"

    ## —— 第六幕：无字的石头 ——

    "你是在一个平凡的春日清晨走的。"
    "遗嘱没有安排仪仗，只让人在城堡那棵苹果树下埋一块无字的石头。"

    if built_school:
        "铁匠铺照常开了门，孩子们照常走进学堂。"
    else:
        "铁匠铺照常开了门，孩子们照常走进教堂侧屋去认字。"

    "各村仍按旧例推举自己的代表。午后，账房把新一页收支抄本贴到了广场的木板上。傍晚有人趁着丧期揭开抄本，抹去了其中几笔。账房当晚对过底稿，把被删的条目原样补回，重新钉好。"

    ## —— 第七幕：史册一角 ——

    "多年后，一名史家从王都议会的驳回卷宗里抽出这些信。封蜡碎了，纸边发黑；艾登堡账册和被捕者名单夹在最下面。"
    "一页页翻下去，提案改了又改。贵族席删去村社列席，城镇行会坚持保留公开账目；有的地方照办，有的地方把公示牌挂上几个月便撤下。"
    "艾登堡那一页最脏。后来的领主撤下公示牌，不再让村社代表进大厅。代表们带着旧账和旧章程守在大厅门外，雨水把纸边浸软了。几经争执，守门人让开了门，公示牌也重新挂回广场。"

    if queen_trust:
        "王后晚年退出议会，住进一座乡间庄园。她留下的卷宗里有一页暗百合的记录：艾登堡领主曾当面交底，页尾没有批注。"
    else:
        "王后拒绝了最初几轮让步。她的派系在争斗中瓦解，最终被迫离开王都；支持旧制度的人仍借她的名义发起过反扑。"

    if baron_peace_path:
        "男爵交出私人军队，后来成了地方议会代表。他熟悉旧贵族的账和人情，因此办成过不少事，也一直有人怀疑他只是换了位置保住权力。"
    else:
        "男爵组织过抵抗，战败后失去头衔和领地。他的旧部并未随之散尽，边地仍有冲突。"

    if prince_ally:
        "弗雷德里克化名去了南方教书。偶尔写些谈责任的文章，从不署王族旧姓。"
    else:
        "弗雷德里克流亡海外。复辟者用他的名字募钱、招兵；后来捐款渐少，边境骚乱却没有立刻停止。"

    if dark_lily_joined:
        "暗百合内部为公开身份和档案争了很久。一部分成员成为公开监察员；不愿公开的人可以离开，不再参与监察。地方议会则要求留下的人公开经费和案卷。"
    elif dark_lily_destroyed:
        "暗百合早已覆灭，只在残缺档案里留下几枚徽记和没有下文的名字。"
    else:
        "暗百合没有在一夜间消失。公开申诉和地方议会建立后，愿意留下的人越来越少，最后一批成员把徽章锁进箱底。"
...
label ending_side_characters_fate:

    ## 确定结局色调
    python:
        if ending_type in ("truth", "peoples_lord", "holy_guardian"):
            _fate_mood = "light"
        elif ending_type in ("iron_lord", "shadow_king"):
            _fate_mood = "neutral"
        else:
            _fate_mood = "dark"   ## borgia, vassal, fall
    ...
    if marcus_returned:
        ...
        if _fate_mood == "light":
            "战后第三个月, 你收到一封没有落款的信。"
            "信纸最上方画着修道院后山那棵歪脖子橡树——你和马库斯当年刻过名字的那一棵。"
            "信里只有一句话: 「冬日蜂巢解散了。我去南边走走。代我向那棵橡树问好。」"
            "你认得他的字。"
        elif _fate_mood == "neutral":
            "战后, 没有人再见过马库斯。"
            "雅各布·凡·霍恩的第三禁卫团反水那一仗里, 他在阵列最前方——后来人们清点战场, 没找到他的尸体, 也没找到他的剑。"
            "你愿意相信他还在某个你不知道的地方, 替别人发烧时把毯子让出去。"
        else:
            "马库斯没能活到最后。"
            "禁卫团反水那一仗成了你能撑到大殿前的唯一原因——但雅各布事后告诉你, 队伍最前面那个穿斗篷的, 他没认出来, 但战后清点伤亡, 那个位置的人没有名字。"
            "你猜得到那是谁。但你没说出来。"
    elif deep_marcus_truly_loyal:
        ## 未回归但忠诚: 悬念 + 哀
        if _fate_mood == "light":
            "你这一年里偶尔会去查王都的禁卫军名册, 没有找到马库斯的名字。"  # canon-ok: 结局尾声, 时间在终章之后, 跨一年合理
            "你愿意相信这是因为他混得比名册上的人更深。"
            "你愿意相信而已。"
        elif _fate_mood == "neutral":
            "马库斯的下落, 你这一年没有打听到任何确切的消息。"  # canon-ok: 结局尾声, 时间在终章之后, 跨一年合理
            "修道院寄来一封信, 说有个叫马库斯的旧学生托人捐了一笔不大不小的善款, 没有留地址。"
            "你把信收在了书桌最底层的抽屉里。"
        else:
            "你这一年里只听到过一次马库斯的名字——是从一个押解犯人的官差嘴里, 顺口提了一句。"  # canon-ok: 结局尾声, 时间在终章之后, 跨一年合理
            "你没敢追问下去。"
    else:
        ## 没建立忠诚: 淡淡的怀旧
        if _fate_mood == "light":
            "修道院的同窗里, 偶尔有人来信。"
            "马库斯不在那些来信的人当中。"
            "但你记得他——尤其是某个春日, 他靠在门框上咬苹果的样子。"
        elif _fate_mood == "neutral":
            "修道院的那些朋友, 这两年里散得各处都是。"
            "马库斯成了你想不起最后一面是哪一年的人。"
        else:
            "修道院的同窗几乎都没有再联络。"
            "你偶尔会想, 当年那个叫马库斯的朋友——大概也已经把你忘了。"
    ...
    if karl_returned:
        ...
        if _fate_mood == "light":
            ...
            "你确实抽空去过一次温特菲尔德村。"
            "他父亲坟前那棵橡树, 已经长得遮天蔽日。"
            "卡尔自己的坟在橡树旁边, 没有立大碑, 只有一块小小的石头, 上面刻着: '温特菲尔德的最后一个商人——他还清了所有的账。'"
            "村里的人说, 他是去年冬天走的。走得很安静。"
        elif _fate_mood == "neutral":
            "卡尔回北方之后, 没有再听到他的消息。"
            "你托人打听过一次, 得到的回答是: 温特菲尔德的橡树下多了一座新坟, 守墓人说那是一个'走南闯北一辈子, 最后才回家的人'。"
            "你没有去亲眼看。你怕去了, 反而对不起他想要的安静。"
        else:
            "卡尔留下的那个木匣, 救了你的命, 也让你走到了今天。"
            "但他自己, 没能等到这一天。"
            "他离开艾登堡的第三个月, 北方下了一场大雪。雪停后, 温特菲尔德村的守墓人在橡树下发现了一具冻僵的身体。"
            "他没有等冬天过去。"
    elif karl_returned_letter_only:
        ## 浅版: 收到一封信, 没再有消息
        if _fate_mood == "light":
            "卡尔留下的那封信, 你保留到了今天。"
            "信里说让你将来去看一眼温特菲尔德的那棵橡树——你这两年没有去。"
            "但你知道, 总有一天你会去。"
        elif _fate_mood == "neutral":
            "卡尔的那封信是他最后留下的东西。"
            "你后来打听过, 温特菲尔德的橡树下确实多了一座坟, 是不是他的, 已经没人能说得清。"
        else:
            "卡尔的信你还留着。"
            "信里的那枚金币, 你用红绳串了起来, 挂在书房的窗钩上。"
            "风吹过的时候, 偶尔会响一下。"
    elif karl_past_done:
        ## 深度认识但未在 ch4-ch5 回归: 怀念 + 悬念
        if _fate_mood == "light":
            "卡尔在你战前的某一天悄悄离开了艾登堡, 没有告别。"
            "你早知道他姓温特菲尔德——那枚他攥了二十年的铜徽章。"
            "你打听过那个家族——已经被王后家族灭了二十年。你猜他回去把家族墓园修了。"
        elif _fate_mood == "neutral":
            "卡尔在你回艾登堡之前就走了。"
            "他跟你说过他真正的姓氏——温特菲尔德。"
            "你希望他能在北方找到他想找的东西。但没有再听到他的消息。"
        else:
            "卡尔在战争开始前就消失了。"
            "你大概知道他回了北方, 那个被王后家族灭门的村子。"
            "你希望他至少能在父亲坟前喝一壶酒。"
            "至于之后——你不愿意去想。"
    elif karl_met:
        ## 浅认识: 淡淡的提及
        if _fate_mood == "light":
            "集市上偶尔还有人提起一个'行走四方的商人卡尔'。"
            "你不确定是不是同一个人。"
        elif _fate_mood == "neutral":
            "市集上那个叫卡尔的商人, 这两年没再来过艾登堡。"
            "他大概有他自己的路要走。"
        else:
            "你想起来还见过一个叫卡尔的商人。"
            "但已经记不清最后一次是什么时候。"
    ...
    ## ── 叔公的下落 (第三章 · 铁刺派支线) ──
    ## 只给走过备用支线的玩家 (fate 为空 = 赴约线/加入线/老档, 整段静默跳过)。
    ## 双轴: ch3_cult_leader_fate(4) × _fate_mood(3)。命名铁律: captured/replaced
    ## 可用"艾德蒙", arrested/negotiated 只能"叔公/首领"(那两条线没报过名)。
    if ch3_cult_leader_fate == "captured":
        if _fate_mood == "light":
            "新法庭收走了艾德蒙。你签了移交文书，没有多写一个字。"

            "听证的日子你没有去王都。有人问起，你说领地走不开。那天你在书房坐了一整个下午。"
        elif _fate_mood == "neutral":
            "艾德蒙还关在艾登堡。地牢里有人按时送饭、换稻草、点灯。"

            "你偶尔走下去坐一会儿。他偶尔说两句话。大多数时候你们只是各自沉默。"
        else:
            "有人说城堡地牢深处还关着一个人。新仆从不敢问，旧仆从不敢答。"

            "你上一次走下去是什么时候？锁没生锈——看守还在轮班。这就够了。"

        pause 1.5
    elif ch3_cult_leader_fate == "arrested":
        if _fate_mood == "light":
            "王都传来消息：铁刺派首领的案子已列入新法庭第三批审理名单。"

            "你没有写信催，也没有替他求情。你在父亲的画像前站了一会儿，然后去批下一份公文。"
        elif _fate_mood == "neutral":
            "铁刺派首领的案子一直没排上。王都有更要紧的事。你也有。"

            "偶尔想起来的时候，通常是因为翻到了父亲的旧物。然后你合上抽屉，接着办公。"
        else:
            "你的叔公还关在王都。你没有问过，王都也没有通知你。"

            "书房里那幅全家画像被你翻了过去，面朝墙。不是因为恨——是因为画里每个人的眼睛都和你一样。"

        pause 1.5
    elif ch3_cult_leader_fate == "negotiated":
        if _fate_mood == "light":
            "温和派彻底回归正统之后，你的叔公就从所有消息里消失了。"

            "有人说在南方的修道院见过一个满脸疤痕的男人。你没有派人去查。"
        elif _fate_mood == "neutral":
            "你的叔公再没有出现过。温和派的人不提他，你也不问。"

            "铁刺派旧据点变成了仓库和马厩。你路过的时候没多看过一眼。"
        else:
            "有传言说你的叔公还活着。也有传言说他死在了路上。两种你都听过。"

            "你把那些传言和所有关于铁刺派的旧事一起，压在案头那摞永远批不完的文书底下。"

        pause 1.5
    elif ch3_cult_leader_fate == "replaced":
        if _fate_mood == "light":
            "新政颁布后第一个月，你下令解散了所有据点。中间人烧掉联络暗号，骨干各领一笔遣散费，走得干干净净。"

            "艾德蒙被移交新法庭。地牢空了之后，你让人在里面存了酒。"
        elif _fate_mood == "neutral":
            "那张网还在。你已经习惯了每周翻阅三份没有署名的密报。"

            "艾德蒙偶尔隔着铁栏问你外面的消息。你偶尔回答。这是你们之间最接近寻常的东西。"
        else:
            "你已经说不清铁刺派还剩多少人了。中间人链条越来越长，末端的人连你的代号都不知道。"

            "艾德蒙在地牢里笑过一次。你没有问他笑什么。你怕他说「你果然和我一样」。"

        pause 1.5

    ## ── 赛琳的归宿 (外章 · 南境) ──
    ## 只给定过情的玩家 —— 他为她拒掉了艾琳娜, 这里得有个交代。
    ## **她的下落是双轴的**: 既看主线结局色调(_fate_mood), 也看他在南边干了什么
    ## (southern_outcome) —— 卖了她港的人和替她保住港的人, 不该收到同一个后来。
    if corsair_romance:
        if southern_outcome == "fall":
            if _fate_mood == "light":
                "有人说在远洋见过一条船。旧船身，新涂装。航线绕开了所有你签过字的港口。每一个。"
                "你不确定是不是她。你希望是。"
            elif _fate_mood == "neutral":
                "渡鸦号没再回过潮汐港。新货主把旧码头拆了一半，建了仓库。"
                "没人知道赛琳去了哪。没人问你。你也不会去问。"
            else:
                "渡鸦号失踪了。不是沉——没有残骸，没有浮木。就是再也没出现。"
                "潮汐港现在叫别的名字。盐路还在跑，利润不错。你签的那份特许状锁在书房第二个抽屉。"
                "有时候你打开那个抽屉。看一眼。关上。"

        elif southern_outcome == "free":
            if _fate_mood == "light":
                "渡鸦号上个月被人在东海岸认出来了。据说她收了一批走不了公会航线的小船主，领着人家跑新路。"
                "你没收到信。也没指望。她走的时候说过——不欠谁，不等谁。"
            elif _fate_mood == "neutral":
                "有南境来的商人提过渡鸦号。说那条船还在跑，旗还挂着。"
                "别的不清楚。她没捎过话，你也没托人问。"
            else:
                "很久没人提过渡鸦号了。潮汐港那边的人说她出过一次远洋，回来以后把联盟的牌子摘了。"
                "没有谁知道她去了哪里。你有时候站在城墙上看南边。不为什么。"

        else:
            ## ruler / vassal / outwit —— 港还在, 但换了个说了算的
            if _fate_mood == "light":
                "南境偶尔有消息来。渡鸦号还在跑，她收了几个年轻船主当徒弟。"
                "她没捎过话给你。你从商人嘴里拼出来的。这样也行。"
            elif _fate_mood == "neutral":
                "有商人从南边来，提过渡鸦号。说还在，旗还挂着。"
                "别的不知道。她没捎过话。你也没托人问。"
            else:
                "渡鸦号还在。但南境来的人说她跑船的次数越来越少，有时候船在港里一停就是半个月。"
                "你知道那不像她。你什么都没做。"
    ...
    ## ── 收尾 ──
    if _fate_mood == "light":
        centered "{size=+4}陪你走到这里的那些人, 名字你都还记得。{/size}"
    elif _fate_mood == "neutral":
        centered "{size=+4}你走到了这里。该记着的人, 你都记着。{/size}"
    else:
        centered "{size=+4}你走到了这里。身后空出来的位置, 你数得清。{/size}"
