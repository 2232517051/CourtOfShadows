...
label prologue_childhood:
    ...
    menu:
        ...
        "父亲，我们家有秘密吗？":
            ...
            $ hide_all_chars()
            "他在骗你。你能感觉到。不是没有秘密——是这个秘密说出来会让你睡不着觉，他不想让一个六岁的孩子背。"
...
label prologue_youth:
    ...
    "按修道院规矩，学生本要五年基础课后才能选专长——但贵族子弟从不照平民学生的节奏走。父亲在信里递了几句话，加上你身上未来领主的身份，让你提前破了例。"
    ...
    "你坐在他对面，想找话说，却发现张不开嘴。两年没见，话堵在喉咙里，一句也递不出去。"
