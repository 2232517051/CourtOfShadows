...
label prologue:
    call new_run_bootstrap from _call_new_run_bootstrap_prologue
...
label prologue_childhood:
    ...
    "他比你高半个头，圆滚滚的脸上挂着一副瞧不起人的神气。他身后跟着两个随从家的孩子，像两条尾巴。"
    ...
    $ hide_all_chars()
    "他伸手推了你一把。力气不算很重，但足够让你踉跄两步。身后那两个孩子笑了。"
    ...
    "他看着壁炉，火光在他眼里跳了两下——然后他像是忘了你坐在旁边。"

    father "先王曾对我说过一句话——「有些信任比血脉更重要。」我到今天都没忘。"
    ...
    menu:
        ...
        "父亲，我们家有秘密吗？":
            ...
            $ hide_all_chars()
            "他在骗你。你能感觉到。不是没有秘密——是这个秘密说出来会让你睡不着觉，他不想让一个六岁的孩子背负这些东西。"
...
label prologue_youth:
    ...
    "按修道院规矩，学生本要五年基础课后才能选专长——但贵族子弟从不照平民学生的节奏走。父亲在信里写了几句话，加上你身上未来领主的身份，让你提前破了例。"
    ...
    menu:
        ...
        "神学。在这个世界上，信仰是最大的权力。":
            ...
            "三年后，你成了修道院里最好的辩手。秘诀很简单：知道什么时候闭嘴。"
    ...
    menu:
        ...
        "去找修道院院长报告。":
            ...
            "老院长听完你的话，捏着祈祷珠不动了。他的表情你读不懂——不像惊讶，更像是……为难。"

            "他让你回去睡觉，说会处理的。"

            "第二天，一切如常。托马斯照常上课。那个黑袍人不见了。院长再也没有提过这件事。"

            "但你注意到一个变化——院长开始经常到你的宿舍区散步。"
    ...
    $ hide_all_chars()
    "三个字。没有拥抱。没有「我想你了」。这是你的父亲。"

    "你坐在他对面，想找话说，却发现张不开嘴。两年没见，话堵在喉咙里，一句也说不出去。"
...
label prologue_adult:
    ...
    "到处是人。贵族、骑士、商人、教士——王都有头有脸的人物，好像全挤进了这座大厅。"
    ...
    "七岁那年，母亲在雪天里走了。"
    "十二岁，你进了圣·尤里安修道院，一待就是六年。"
    "如今父亲也走了，留给你一封信、书房里的老地方，和整个艾登堡。"
